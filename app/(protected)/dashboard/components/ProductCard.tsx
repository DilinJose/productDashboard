...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  useGSAP(() => {
    if (!containerRef.current || !imageRef.current || !panelRef.current) return;
  ...
  return (
    <div
      ref={containerRef}
      className="relative rounded-lg aspect-[4/5] w-full overflow-hidden cursor-pointer"
    ...
    >
      ...
      <div ref={panelRef} className="absolute bottom-0 left-0 w-full">
        <div className="w-full flex flex-col items-center gap-3 px-4 py-5 bg-[#232323]">
